...
// User Email Verify
userRoute.post(
  "/verify-email/:username/:randString",
  userEmailVerify("customer")
)
...
userRoute.post(
  "/check-string/:username/:randString",
  userRandStringCheck("customer")
)

// User Reset Password
userRoute.post(
  "/reset-pass/:username/:randString",
  userResetPassword("customer")
)
